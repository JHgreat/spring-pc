		...
		<div class="main-content">
			<form action="mypcUpdate.do" name="frm" method="post" onsubmit="return upload()" enctype="multipart/form-data">
				...
				<div class="join_total">
					...
					<div>pc방 전화번호</div>
					<div class="join_content">
						<input type="tel" name="pcpno" value="${pc.pcpno }" required="required" pattern="02-\d{3,4}-\d{4}"
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=40d54373286f7846a976d0cc431f8cf6&libraries=services"></script>
<script>
